...
<head>
    ...
    <title><?php echo $SERVER_NAME ?> | Developer-Bewerbung</title>
...
<?php
    if(isset($_POST["submit"])){
      mail("apply@test.de", "Developer Bewerbung", 'Name: '.$_POST["deinname"].' Alter: '.$_POST["deinalter"].' E-Mail-Adresse: '.$_POST["deineemail"].' Erfahrungen: '.$_POST["erfahrungen"].' Kompetenzen: '.$_POST["kompetenzen"].' Referenzen: '.$_POST["referenzen"].' Schlusswort: '.$_POST["schluss"]);
      ?>
...
<div class="container">
    ...
    <form action="DeveloperFormular.php" method="post" class="form-horizontal">
        <div class="panel-body">
                        <h2>Developer - Bewerbungsformular</h2>
            <hr />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">Welche Erfahrungen hast du im Bereich Entwicklung schon gemacht und warum sollten wir ausgerechnet dich einstellen? Was kannst du, was kannst du nicht so gut?</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">Welche Programmiersprachen beherrscht du, wie lange schon und was kann uns noch von dir als Entwickler überzeugen?</span>
                    </div>
                </div>
                <div class="form-group">
