...
<div class="container">
    ...
    <div class="panel-body">
                <h2>Builder</h2>
        <p>Falls du dich als Builder bewerben willst, solltest du die folgenden Punkte lesen.</p>
<h3>Dein Profil</h3>
<ul>
...
<h4>Anforderungen für Builder</h4>
<ul>
    <li>-</li>
    <li>-</li>
    <li>-</li>
...
<ol>
	...
	<li>Sollte deine Bewerbung angenommen werden, wirst du zu einem Gespräch auf unserem TeamSpeak (<tt><?php echo $SERVER_NAME ?></tt>) eingeladen, dort wird dir eine Testaufgabe gegeben um deine Fähigkeiten zu testen.</li>
    <li>Nach der Abgabe und auswertung dieser Aufgabe, wird entschieden ob du in die Testphase aufgenommen wirst.</li>
    <li>Solltest du in die Testphase aufgenommen werden, wirst du einige weitere, Serverbezogene Testaufgabe bekommen.</li>
    <li>Löst du auch diese Aufgaben nach unseren Anforderungen wird erneut entschieden ob du als Vollwertiger Builder aufgenommen wirst.</li>
</ol>
	...
	<li>Arbeit an einem spannenden und wachsendem Prokjekt</li>
        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
                <a href="BuilderFormular.php" class="btn group-btn builder btn-lg btn-block"><span><i class="fas fa-cubes fa-fw"></i></span>Jetzt bewerben</a>
            </div>
        </div>
    </div>
