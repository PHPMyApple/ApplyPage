...
<head>
    ...
    <title><?php echo $SERVER_NAME ?> | Supporter-Bewerbung</title>
...
<?php
    if(isset($_POST["submit"])){
      mail("apply@test.de", "Suppoerter Bewerbung", 'Name: '.$_POST["deinname"].' Alter: '.$_POST["deinalter"].' E-Mail-Adresse: '.$_POST["deineemail"].' Erfahrungen: '.$_POST["erfahrungen"].' Kompetenzen: '.$_POST["kompetenzen"].' Referenzen: '.$_POST["referenzen"].' Schlusswort: '.$_POST["schluss"]);
      ?>
...
<div class="container">
    ...
    <form action="SupporterFormular.php" method="post" class="form-horizontal">
        <div class="panel-body">
                        <h2>Supporter - Bewerbungsformular</h2>
            <hr />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">Welche Erfahrungen hast du im Bereich Support schon gemacht und warum sollten wir ausgerechnet dich einstellen? Was kannst du, was kannst du nicht so gut?</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">  
                        ...
                        <span class="help-block">Wie gehts du mit schwierigen Situationen um und was tust du bei den etwas besonderen Usern?</span>
                    </div>
                </div>
				    <div class="form-group">
